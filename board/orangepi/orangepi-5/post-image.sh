...
${ubootDir}/tools/mkimage -n rk3588 -T rksd -d board/orangepi/orangepi-5/rkbin/bin/rk35/rk3588_ddr_lp4_2112MHz_lp5_2400MHz_v1.16.bin:${BINARIES_DIR}/u-boot-spl.bin ${BINARIES_DIR}/idbloader.img
